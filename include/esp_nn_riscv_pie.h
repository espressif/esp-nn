...
int esp_nn_get_conv_scratch_size_riscv_pie(const data_dims_t *input_dims,
                                         ...
                                         const data_dims_t *output_dims,
                                         const conv_params_t *conv_params);
void esp_nn_set_conv_scratch_buf_riscv_pie(const void *buf);
...
void esp_nn_add_elementwise_s8_riscv_pie(const int8_t *input1_data,
                                        ...
                                        const int32_t size);
#define esp_nn_add_elementwise_s8 esp_nn_add_elementwise_s8_riscv_pie
...
#define esp_nn_depthwise_conv_s8 esp_nn_depthwise_conv_s8_riscv_pie

#define esp_nn_conv_s8 esp_nn_conv_s8_riscv_pie

#define esp_nn_get_conv_scratch_size esp_nn_get_conv_scratch_size_riscv_pie
#define esp_nn_set_conv_scratch_buf esp_nn_set_conv_scratch_buf_riscv_pie

#define esp_nn_get_depthwise_conv_scratch_size esp_nn_get_depthwise_conv_scratch_size_riscv_pie
#define esp_nn_set_depthwise_conv_scratch_buf esp_nn_set_depthwise_conv_scratch_buf_riscv_pie

/* Functions not yet optimized for P4 - use ANSI fallback */
void esp_nn_hard_swish_s8_riscv_pie(const int8_t *input, int8_t *output,
                                   const int32_t size,
...
#define esp_nn_hard_swish_s8 esp_nn_hard_swish_s8_riscv_pie
#define esp_nn_get_hard_swish_scratch_size() 0
#define esp_nn_set_hard_swish_scratch_buf(buf)

void esp_nn_mean_nhwc_s8_riscv_pie(const int8_t *input, int8_t *output,
                                  ...
                                  const int32_t shift);
#define esp_nn_mean_nhwc_s8 esp_nn_mean_nhwc_s8_riscv_pie

void esp_nn_relu6_s8_riscv_pie(int8_t *data, uint16_t size);
#define esp_nn_relu6_s8 esp_nn_relu6_s8_riscv_pie
...
#define esp_nn_avg_pool_s8 esp_nn_avg_pool_s8_riscv_pie
void esp_nn_max_pool_s8_riscv_pie(const int8_t *input,
                                 ...
                                 const int32_t activation_max,
                                 const uint16_t channels);
#define esp_nn_max_pool_s8 esp_nn_max_pool_s8_riscv_pie
...
void esp_nn_fully_connected_per_ch_s8_riscv_pie(const int8_t *input_data,
                                        ...
                                        const int32_t activation_min,
                                        const int32_t activation_max);
#define esp_nn_fully_connected_s8 esp_nn_fully_connected_s8_riscv_pie
#define esp_nn_fully_connected_per_ch_s8 esp_nn_fully_connected_per_ch_s8_riscv_pie
...
void esp_nn_softmax_s8_riscv_pie(const int8_t *input_data,
                                ...
                                int8_t *output_data);
#define esp_nn_get_softmax_scratch_size esp_nn_get_softmax_scratch_size_riscv_pie
#define esp_nn_set_softmax_scratch_buf esp_nn_set_softmax_scratch_buf_riscv_pie
#define esp_nn_softmax_s8 esp_nn_softmax_s8_riscv_pie
